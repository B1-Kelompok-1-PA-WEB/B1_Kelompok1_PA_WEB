...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/pesanan_pembeli.css">
      ...
      <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link mr-5" href="menu_pembeli.php">Menu</a>
            </li>
            <li class="nav-item">
              <a class="nav-link mr-5 activated" href="pesanan_pembeli.php">Orders</a>
            </li>
            <li class="nav-item">
  ...
  <!-- Menu -->
    <div class="container">
      <div class="judul-pesanan mt-5">
        ...
        <h3 class="text-center font-weight-bold">DAFTAR PESANAN ANDA</h3>
