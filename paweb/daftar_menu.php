...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/daftar_menu.css">
      ...
      <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link mr-5" href="admin.php">Home</a>
            </li>
            <li class="nav-item">
              <a class="nav-link mr-5 activated" href="daftar_menu.php">Menu</a>
            </li>
            <li class="nav-item">
